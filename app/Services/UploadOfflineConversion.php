...
//   ##### Arquivo usado unicamente para fase de testes via CMD #######
...
{
    private $customerID;
    private const CUSTOMER_ID = '3790851500';
    // private $conversionActionId;
    private const CONVERSION_ACTION_ID = '6744551735';

    // Set exactly one of GCLID, GBRAID, or WBRAID.
    // The Google Click ID for which conversions are uploaded.
    private $gclid;
    private const GCLID = 'CjwKCAjwkJm0BhBxEiwAwT1AXBh7kB8jl7KGXK_2neSLwNzh_UYDTQkNSXZkBIZc8x-Hi6zQdJtfYxoCbWwQAvD_BwE';
    ...
    private const CONVERSION_DATE_TIME = '2024-07-05 00:52:59-03:00';
    private $conversionDateTime;
    private const CONVERSION_VALUE = 1.00;
...
//            ->build();
    ...
    public static function runExample(
        ...
        $response = $conversionUploadServiceClient->uploadClickConversions(
            \Google\Ads\GoogleAds\V17\Services\UploadClickConversionsRequest::build(
                $customerId,
                [$clickConversion],
                true
            )
